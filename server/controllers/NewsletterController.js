...
const { newsletterWelcomeTemplate } = require("../mailer/templates");
    ...
    try {
        ...
        try {
            await mailer.sendMail({
                ...
                to: data.email,
                subject: `Welcome to Our Newsletter - ${process.env.SITE_NAME || "CTech Ethics"}`,
                html: newsletterWelcomeTemplate({
                    email: data.email
                })
            });
            console.log(`Newsletter subscription confirmation sent to ${data.email}`);
        } catch (e) {
