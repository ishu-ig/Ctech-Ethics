...
export default function AdminUpdateTestimonial() {
  ...
  let [error, setError] = useState({ name: "", designation: "", pic: "", message: "" });
  ...
  function getInputData(e) {
    ...
    if (["name", "designation", "message", "pic"].includes(name)) {
      setError((old) => ({
        ...old,
              ...
              <div className="row g-3">
                ...
                <div className="col-md-6">
                  ...
                  <input
                    ...
                    className="form-control" placeholder="e.g. Marketing Manager"
                    value={data.designation} onChange={getInputData}
                  />
                  {show && error.designation && <div className="text-danger small mt-1">{error.designation}</div>}
                </div>

                {/* Company */}
                <div className="col-md-6">
                  <label className="form-label" htmlFor="company">Company <span className="text-muted fw-normal">(optional)</span></label>
                  <input
                    id="company" type="text" name="company"
                    className="form-control" placeholder="e.g. Acme Inc."
                    value={data.company} onChange={getInputData}
                  />
                </div>
                ...
                <div className="col-md-6">
                  ...
                  <select
                    ...
                    value={data.rating} onChange={getInputData}
                  >
                    {[1, 2, 3, 4, 5].map((n) => (
