...
const checklist = [
  { dot: "bg-success", title: "Pick an icon", body: "Use a Bootstrap/FontAwesome icon class (e.g. bi bi-trophy)." },
  { dot: "bg-primary", title: "Set the count", body: "The stat number or string (e.g. 232, 100+)." },
  { dot: "bg-warning", title: "Add context", body: "Fill in the Title and Description." },
];
...
export default function AdminCreateAchievement() {
  ...
  const [error, setError] = useState({
    ...
    count: "Count Field is Mandatory",
  ...
  }, [dispatch, AchievementStateData.length]);
        ...
        <div className="page-heading">
          <div className="page-heading-copy">
            ...
            <div>
              ...
              <p className="text-muted mb-0">Create a new achievement stat.</p>
            </div>
          </div>
        ...
        <section className="row g-3">
            ...
            <div className="panel">
              <div className="panel-header">
                <div>
                  ...
                  <p className="text-muted mb-0">Fill in the details to create a new stat.</p>
                </div>
              </div>
              ...
              <div className="d-flex flex-wrap justify-content-end gap-2 mt-4">
                ...
                <button className="btn btn-primary" type="button" onClick={postSubmit}>
                  <i className="bi bi-check-circle"></i> Create Achievement
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="col-12 col-xl-4">
            <div className="panel h-100">
              <h2 className="h5 mb-3 section-title"><i className="bi bi-list-check"></i> Setup Checklist</h2>
