...
import { createPlacement, getPlacement } from "../../../Redux/ActionCreators/PlacementActionCreators";
...
const checklist = [
    { dot: "bg-success", title: "Add the logo", body: "Square logos crop best in the listing thumbnail." },
    { dot: "bg-primary", title: "Set eligibility", body: "Who qualifies to apply — rich text supported." },
    { dot: "bg-warning", title: "Add the apply link", body: "Where candidates go to submit their application." },
];
                ...
                <div className="page-heading">
                    <div className="page-heading-copy">
                        ...
                        <div>
                            ...
                            <h1 className="h3 mb-1">Add Placement</h1>
                            <p className="text-muted mb-0">
                                Post a new placement job listing.
                            </p>
                        </div>
                    </div>
                            ...
                            <div className="row g-3">
                                <div className="col-12">
                                    <label className="form-label" htmlFor="companyLogo">
                                        Company Logo <small className="text-muted">(optional)</small>
                                    </label>
                        ...
                        <div className="panel">
                            ...
                            <div className="d-flex flex-wrap justify-content-end gap-2 mt-4">
                                ...
                                <button className="btn btn-primary" type="button" onClick={postSubmit}>
                                    <i className="bi bi-check-circle" aria-hidden="true"></i> Create Placement
                                </button>
                            </div>
                        </div>
                    </div>
