...
import { createCareer, getCareer } from "../../../Redux/ActionCreators/CareerActionCreators";
...
const checklist = [
  { dot: "bg-success", title: "Set the deadline", body: "Applications close automatically after this date." },
  { dot: "bg-primary", title: "List the essentials", body: "Responsibilities, eligibility, and benefits support rich text; skills are tags." },
  { dot: "bg-warning", title: "Pin the location", body: "City and state are required; lat/lng are optional." },
];
        ...
        <div className="page-heading">
          <div className="page-heading-copy">
            ...
            <div>
              ...
              <h1 className="h3 mb-1">Add Career</h1>
              <p className="text-muted mb-0">
                Post a new open position.
              </p>
            </div>
          </div>
            ...
            <div className="panel">
              ...
              <div className="d-flex flex-wrap justify-content-end gap-2 mt-4">
                ...
                <button className="btn btn-primary" type="button" onClick={postSubmit}>
                  <i className="bi bi-check-circle" aria-hidden="true"></i> Create Career
                </button>
              </div>
            </div>
          </div>
