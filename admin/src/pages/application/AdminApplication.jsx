...
export default function AdminApplications() {
    ...
    function updateStatus(_id, newStatus) {
        ...
        if (window.confirm(`Change status to "${newStatus}"?`)) {
            dispatch(updateApplication({ ...item, status: newStatus }));
            setFlag(!flag);
        }
    }
    ...
    const filteredData = ApplicationStateData
        ? ApplicationStateData.filter(
            (item) =>
                    ...
                    <section className="panel mt-3">
                        <div className="panel-header">
                            <div>
                                ...
                                <p className="text-muted mb-0">
                                    Search, review, and manage candidate applications.
                                </p>
                            </div>
                        ...
                        <div className="table-responsive">
                            <table className="table align-middle mb-0" id="applicationTable">
                                <thead>
                                    <tr>
                                        <th scope="col">#</th>
                                    ...
                                    {filteredData.length > 0 ? (
                                        filteredData.map((item, index) => (
                                            <tr key={item._id}>
                                                ...
                                                {/* <td>
                                                    <div className="app-message text-muted">{item.message}</div>
                                                </td> */}
                                                <td>
                                                    <select
                                                        className={`app-status-select ${STATUS_BADGE[item.status] || "text-bg-secondary"}`}
                                                        value={item.status}
